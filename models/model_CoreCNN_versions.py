from models.model_CoreCNN import CoreUnet, CoreEncoder,GeolocationUnet
...
def CoreUnetGeolocation_nano(**kwargs):
    """
    Total params: 65,391,879
    Trainable params: 65,391,879
    Non-trainable params: 0
    Total mult-adds (T): 1.54
    =========================================================================================================
    Input size (MB): 33.55
    Forward/backward pass size (MB): 50140.52
    Params size (MB): 261.57
    Estimated Total Size (MB): 50435.64
    """
    model = GeolocationUnet(depths=[2, 2, 8, 2], dims=[80*2, 160*2, 320*2, 640*2], **kwargs)
    return model
